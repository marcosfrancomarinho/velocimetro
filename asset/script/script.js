...
function accelerator() {
    speed = setInterval(() => {
        if (contador > 120) {
            ...
            displayKm.setAttribute("class", "high-speed");
            displayMiles.setAttribute("class", "high-speed");
            ...
            displayKm.innerHTML = kilometersHour(contador);
            displayMiles.innerHTML = milesHour(contador);
            displayKm.setAttribute("class", "normal-speed");
            displayMiles.setAttribute("class", "normal-speed");
